...
describe Import::CSVParser do
  ...
  context 'Import a simple record' do
    it 'parses a record' do
      ...
      expect(first_record.keys).to match_array ["object unique id", "level", "title", "subject:topic", "agent:creator", "agent:contributor", "subject:spatial", "date:created", "note:note", "identifier:doi", "language", "type of resource", "copyright jurisdiction", "copyright status", "related resource"]
    end
  end
end
