class ContentBlock < ApplicationRecord
  ...
  class << self
    ...
    def faq_page
      find_or_create_by(name: 'faq_page')
    end

    def faq_page=(value)
      faq_page.update(value: value)
    end

    def takedown_page
      find_or_create_by(name: 'takedown_page')
    end

    def takedown_page=(value)
      takedown_page.update(value: value)
    end
